...
Be concise but thorough. Focus on actionable insights.""",
    ...
    def diagnose(self, alert_info: Dict[str, Any], triage_report: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def diagnose_multiple(self, investigations: list[Dict[str, Any]]) -> list[Dict[str, Any]]:
        """
